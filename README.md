...
I'm a front-end developer who enjoys turning ideas into clean, responsive interfaces — and I'm steadily expanding into full-stack territory. I care about the details: layout, accessibility, and making things feel good to use, not just look good.
...
- 🎨 Focused on **UI/UX** — pixel-perfect and accessible by default
- 🐍 Writing **Python** for scripting and automation
- 🌱 Currently leveling up in **Advanced JavaScript** and **React**
- 💬 Happy to talk **HTML, CSS, JavaScript, Tailwind, Figma**
- 📫 Open to **front-end internship** opportunities
